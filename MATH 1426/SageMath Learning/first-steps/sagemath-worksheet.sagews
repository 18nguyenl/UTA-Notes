...
︡dc022f75-1820-4da6-8e36-e88888cbd939︡{"stdout":"844413768687395500873087283856\n"}︡{"done":true}︡
...
x, y = var('x, y')
︡4739f441-bd83-4bdc-9276-7b7bf8bdc761︡{"done":true}︡
...
z = x / (1 + y^2)
show(z)
︡2214b780-8a88-4c03-9525-a03e4032975c︡{"html":"<div align='center'>$\\displaystyle \\frac{x}{y^{2} + 1}$</div>"}︡{"done":true}︡
...
z(x = 4, y = 2)
︡0e17660b-e6ad-4d27-87fb-b1e2b4c1d7e2︡{"stdout":"4/5\n"}︡{"done":true}︡
...
f(x) = 2 * x + cos(x)
show(f(x))
︡1595ba49-121f-4951-a668-614a2ff2d082︡{"html":"<div align='center'>$\\displaystyle 2 \\, x + \\cos\\left(x\\right)$</div>"}︡{"done":true}︡
...
show(f(4 * pi))
︡fa025248-416f-4458-8f1e-2eb3803d4bf0︡{"html":"<div align='center'>$\\displaystyle 8 \\, \\pi + 1$</div>"}︡{"done":true}︡
